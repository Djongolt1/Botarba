...
# ======= АВТООТПРАВКА ВСЕХ ПАР (ИСПРАВЛЕНО) =======
async def auto_send_all(bot):  # Принимает bot, а не context
...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Отправляем клавиатуру отдельным сообщением после графика, чтобы она была внизу
