...
# ⚡️ УДАЛЕНЫ ПАРЫ "Ростелеком" и "Сбер" – оставлены только Мечел и Татнефть
PAIRS = {
    "Мечел": ("MTLR", "MTLRP"),
    "Татнефть": ("TATN", "TATNP"),
}
...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Обработка устаревших callback-запросов
    try:
        await query.answer()
...
async def main():
    ...
    # Запуск поллинга с игнорированием старых обновлений (drop_pending_updates=True)
